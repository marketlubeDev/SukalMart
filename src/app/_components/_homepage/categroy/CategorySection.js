...
export default function CategorySection() {
  ...
  return (
    <>
      <div
        className="flex flex-col items-center justify-center w-full overflow-hidden px-2 sm:px-4 md:px-6 lg:px-8 xl:px-[200px] py-6 md:py-8 lg:py-10 max-w-6xl mx-auto"
        style={{
          display: "flex",
