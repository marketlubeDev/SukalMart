  ...
  return (
    <>
      <div
        className={
          isProductPage
            ? "py-6 md:py-8 lg:py-10 overflow-hidden px-0 sm:px-0 md:px-0 lg:px-4 xl:px-4"
            : "py-6 md:py-8 lg:py-10 overflow-hidden mx-auto w-full max-w-screen-xl px-4 sm:px-0 md:px-8 lg:px-4 xl:px-10"
        }
      >
