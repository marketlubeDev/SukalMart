...
export default function HeroBanner() {
  ...
  //     description:
  //       "Explore our curated selection of premium beauty products designed to enhance your natural beauty and boost your confidence.",
  //   },
  //   {
  //     id: 2,
  ...
  //     description:
  //       "Get ready for summer with our essential beauty products that keep you looking fresh and radiant all day long.",
  //   },
  //   {
  //     id: 3,
  ...
  //     description:
  //       "Transform your hair with our professional-grade hair care products that deliver salon-quality results at home.",
  //   },
  //   {
  //     id: 4,
  ...
  //     description:
  //       "Experience the future of skincare with our advanced formulations that target your specific skin concerns.",
  //   },
  // ];

  console.log(banners, "bandfdfdfdners");
