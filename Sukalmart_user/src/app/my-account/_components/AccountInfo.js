    ...
    <div className="bg-white rounded-lg p-6">
      ...
      <div className="space-y-6">
        ...
        <button
          ...
          className="px-4 py-2 bg-transparent border border-[var(--color-primary)] text-[var(--color-primary)] rounded-md hover:bg-[var(--color-primary)]/10 transition-colors cursor-pointer"
        >
          Logout
        </button>
      </div>
