          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between">
                  <span className="text-gray-600">{t("nav.products")}:</span>
                  <span className="font-medium">{t("nav.products")}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">{t("nav.categories")}:</span>
                ...
                <div className="flex justify-between">
                  <span className="text-gray-600">{t("nav.contact")}:</span>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <div className="space-y-3">
                <div className="flex justify-between">
                  <span className="text-gray-600">{t("homepage.featured.title")}:</span>
                  <span className="font-medium">{t("homepage.featured.title")}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">{t("homepage.categories.title")}:</span>
                  <span className="font-medium">{t("homepage.categories.title")}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">{t("homepage.bestSellers.title")}:</span>
                  <span className="font-medium">{t("homepage.bestSellers.title")}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">{t("homepage.services.title")}:</span>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <div className="space-y-3">
                <div className="flex justify-between">
                  <span className="text-gray-600">{t("product.addToCart")}:</span>
                  <span className="font-medium">{t("product.addToCart")}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">{t("product.addToWishlist")}:</span>
                  <span className="font-medium">{t("product.addToWishlist")}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">{t("product.outOfStock")}:</span>
                  <span className="font-medium">{t("product.outOfStock")}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">{t("product.inStock")}:</span>
